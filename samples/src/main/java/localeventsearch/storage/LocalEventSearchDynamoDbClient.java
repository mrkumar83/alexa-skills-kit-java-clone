...
import scorekeeper.storage.ScoreKeeperUserDataItem;

import com.amazonaws.services.dynamodbv2.AmazonDynamoDBClient;
import com.amazonaws.services.dynamodbv2.datamodeling.DynamoDBMapper;

public class LocalEventSearchDynamoDbClient {
    private final AmazonDynamoDBClient dynamoDBClient;
    
    public LocalEventSearchDynamoDbClient(final AmazonDynamoDBClient dynamoDBClient) {
     ...
     * @return
     */
    public LocalEventSearchUserDataItem loadItem(final LocalEventSearchUserDataItem tableItem) {
        DynamoDBMapper mapper = createDynamoDBMapper();
        LocalEventSearchUserDataItem item = mapper.load(tableItem);
        return item;
    }
